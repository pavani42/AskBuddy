...
public class TestQuestionController {
	...
	public void testAnswerEntity()
	{
		...
		answers.setDate(null);
		answers.setDescription(null);
		answers.setId(0);
		answers.setLikesList(null);
		...
		answers.getLikesList();
		answers.getQuestion();
		answers.getUser();
		answers.hashCode();
		Answers ans = Answers.builder().build();
		Answers ans1 = new Answers(1, null, user, null, null, null);
	}
	
	@Test
	public void testLikesEntity()
	{
	...
	public void testGetQuestion() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(get("/api/questions/question/" + 1).accept(MediaType.APPLICATION_JSON))
	...
	public void testSearchQuestion() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(get("/api/questions/searchQuestionByKeyword/is").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());
	...
	public void testSearchByCategory() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(get("/api/questions/searchQuestionByCategory/Technology").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
	}
	...
	public void testSearchBySubCategory() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(get("/api/questions/searchQuestionBySubCategory/Java").accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
	...
	public void testPostQuestion() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(post("/api/questions/postQuestion" + "?category=" + question.getCat().getCat_name()
	...
	public void testUpdateQuestion() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(post("/api/questions/updateQuestion/" + 1 + "?question=What is abstraction?")
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
	...
	public void testDeleteQuestion() throws Exception
	{
		...
		MockHttpServletResponse response = mockMvc.perform(delete("/api/questions/question/" + 1)
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
	...
	public void testGetLatestQuestion() throws Exception
	{
		...
		List<QueAndAns> queAndAns = new ArrayList<>();
		queAndAns.add(QueAndAns.builder().question(question).AnswerList(new ArrayList<Answers>()).build());
		MockHttpServletResponse response = mockMvc.perform(get("/api/questions/latestQuestions")
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
	...
	public void testGetByUser() throws Exception
	{
		...
		Mockito.when(authuser.getUser()).thenReturn(user);
		MockHttpServletResponse response = mockMvc.perform(get("/api/questions/questionByUser")
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
	...
	public void testGetCategoryList() throws Exception
	{
		...
		MockHttpServletResponse response = (MockHttpServletResponse) mockMvc.perform(get("/api/questions/getCategoryList")
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
	...
	public void testGetSubCategoryList() throws Exception
	{
		...
		MockHttpServletResponse response = (MockHttpServletResponse) mockMvc.perform(get("/api/questions/getSubCategoryList/" + category.getCat_name())
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
	...
	public void testGetQuestionByList() throws Exception
	{
		...
		MockHttpServletResponse response = (MockHttpServletResponse) mockMvc.perform(get("/api/questions/getQuestionsByCategory?cat=" + category.getCat_name() + "&subCat=" + subCat.getSubcat_name())
				.accept(MediaType.APPLICATION_JSON))
				.andReturn().getResponse();
		assertEquals(response.getStatus(), HttpStatus.OK.value());
		assertFalse(response.getContentAsString().isEmpty());	
