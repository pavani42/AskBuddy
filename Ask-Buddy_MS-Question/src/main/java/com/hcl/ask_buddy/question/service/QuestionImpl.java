...
//			throw new IdNotFoundException("No Question found with the given word");
	...
	public List<QueAndAns> getQuestionAndAnswerList(List<Question> questionList)
	{
		...
		List<QueAndAns> qalist1 = new ArrayList<QueAndAns>();
//		qalist1.addAll(questionList.forEach(question -> {
//			QueAndAns qa = new QueAndAns();
//			qa.setQuestion(question);
//			qa.setAnswerList(answerRepo.getAnswerByQuestionId(question));
//		}));
	...
	public Question postQuestion(String cat, String subCat, String question, String questionDescription) {
		...
		if(questionRepository.getQuestionByQuestion(question) == null)
		{
			...
			question1.setUser(userRepo.findById(authUser.getUser().getMail()).get());
	...
	public Question getQuestionByquestion(String question) {
		...
		return questionRepository.getQuestionByQuestion(question);
	}
